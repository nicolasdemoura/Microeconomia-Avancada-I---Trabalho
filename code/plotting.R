...
gg_bar <- function(plot_data, x_var, y_var, title, subtitle = NULL,
    ...
    p <- p + 
        ...
        theme(
            ...
            axis.title.x = element_text(size = 14, color = "#2c3e50", face = "bold",
                                      margin = margin(t = 10)),
            axis.title.y = element_text(size = 14, color = "#2c3e50", face = "bold",
                                      angle = 90, margin = margin(r = 10)),
            axis.text.x = element_text(size = 14, color = "#2c3e50", 
                                     margin = margin(t = 5)),
...
gg_histogram <- function(plot_data, x_var, title, subtitle = NULL,
    ...
    p <- p + 
        ...
        theme(
            ...
            plot.subtitle = element_text(size = 12, color = "#7f8c8d", 
                                       margin = margin(b = 20)),
            axis.title = element_text(size = 14, color = "#2c3e50", face = "bold"),  # Increased from 11 to 14
            axis.text = element_text(size = 14, color = "#2c3e50"),  # Increased from 10 to 12
            legend.title = element_text(size = 14, color = "#2c3e50", face = "bold"),  # Added larger legend title
            legend.text = element_text(size = 12, color = "#2c3e50"),  # Increased from 10 to 12
...
gg_rmsp_base <- function(RMSP, title = "", subtitle = NULL,
                        ...
                        fill_color = "#f8f9fa", border_color = "#2C3E50",
                        show_centroids = FALSE, centroid_color = "#CC0000") {
    ...
    p <- p + 
        ...
        theme(
            ...
            # Legend styling - increased font size
            legend.title = element_text(size = 14, color = "#2c3e50", face = "bold"),
            legend.text = element_text(size = 12, color = "#2c3e50"),  # Increased from 10 to 12
