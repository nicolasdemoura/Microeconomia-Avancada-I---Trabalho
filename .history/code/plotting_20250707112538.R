...
gg_rmsp_base <- function(RMSP, title = "", subtitle = NULL,
    ...
    p <- p + 
        ...
        theme_void() +
        theme(
            # Text styling with increased sizes
            plot.title = element_text(size = 20, face = "bold", color = "#2c3e50", 
                                    margin = margin(b = 10), hjust = 0),
            plot.subtitle = element_text(size = 16, color = "#7f8c8d", 
                                       margin = margin(b = 20), hjust = 0),
            axis.title.x = element_text(size = 16, color = "#2c3e50", face = "bold"),
            axis.title.y = element_text(size = 16, color = "#2c3e50", face = "bold"),
...
gg_rmsp_voronoi <- function(RMSP, stations, voronoi_polygons, title = "", subtitle = NULL,
    ...
    p <- p + 
        ...
        theme(
            ...
            # Legend styling with increased sizes
            legend.title = element_blank(),
