...
gg_bain_bar <- function(plot_data, x_var, y_var, title, subtitle = NULL,
...
gg_bain_histogram <- function(plot_data, x_var, title, subtitle = NULL,
...
gg_bain_area <- function(plot_data, x_var, y_var, fill_var, title, subtitle = NULL,
