...
###############################################################################
# Create Bain & Company style visualizations
###############################################################################
...
# Create rainfall histogram using Bain style
rainfall_hist <- gg_bain_histogram(
    ...
    y_label = "Frequency",
    filename = "figures/rainfall_histogram_bain.png",
    bar_color = "#CC0000",
    bins = 50
)

# Create trips histogram using Bain style
trips_hist <- gg_bain_histogram(
    plot_data = analysis_data,
    x_var = "num_trips",
    ...
    y_label = "Frequency",
    filename = "figures/trips_histogram_bain.png",
    bar_color = "#46647B",
    bins = 20
)

print("Bain & Company style visualizations created successfully!")
