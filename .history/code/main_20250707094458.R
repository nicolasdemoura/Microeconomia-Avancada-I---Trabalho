...
print(paste("Panel 1 observations:", nobs(analysis_results$panel1_models$`Model 1`)))
print(paste("Panel 2 observations:", nobs(analysis_results$panel2_models$`Model 1`)))
