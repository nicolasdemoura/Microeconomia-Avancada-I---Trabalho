...
# Create RMSP map with closest station assignments
rmsp_closest <- gg_rmsp_closest_stations(
    RMSP = closest_results$RMSP,
    stations = stations,
    title = "RMSP Zones by Closest Weather Station",
    subtitle = "Each zone colored by its assigned closest CEMADEN station",
    filename = "figures/rmsp_closest_stations.png",
    show_stations = TRUE,
    show_centroids = TRUE
)

print("Spatial visualizations created successfully!")